        ...
        $listIcon=[
            ...
            'stok'=>'<span class="svg-icon svg-icon-2 '.$class.'">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path opacity="0.3" d="M14 13H21C21.6 13 22 13.4 22 14V21C22 21.6 21.6 22 21 22H14C13.4 22 13 21.6 21 21V14C13 13.4 13.4 13 14 13Z" fill="currentColor"/>
            ...
            'play'=>'<span class="svg-icon svg-icon-2 '.$class.'">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
