...
<div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <table class="table align-middle  fs-6 gy-3 gs-3 table-hover table-sm table-row-bordered " id="main-table">
                                ...
                                <thead>
                                    ...
                                    <tr class="fw-bold text-muted bg-light">
                                        ...
                                        <th class="m-w-50px text-end">Status</th>
                ...
                <form action="{{$config['action']}}" method="post" enctype="multipart/form-data"id="kt_form_main" autocomplete="off">
                    ...
                    <div class="card card-flush mb-0" 
                        ...
                        <div class="card-header pt-7">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark">{!!$config['title-icon']!!}Tambah Paket Menu</span>
                            </h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Card header-->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-1 fv-row">
                                        <label for="name" class="required form-label">Paket Menu</label>
                                        <input type="text" name="name" class="form-control form-control-sm form-control-solid" maxlength="60" placeholder="Paket Menu:...">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="mb-1 fv-row">
                                        <label for="is_active" class="required form-label">Aktif</label>
    ...
    @include('packet_menus.modal')
</div>
@endsection
@section('script')
@include('packet_menus.index_script')
@endsection