...
@endsection
@section('content')
<div id="kt_app_content" class="app-content flex-column-fluid pb-4">
    ...
    <div id="kt_app_content_container" class="container-fluid">
        ...
        <!-- <div class="row gy-5 g-xl-10"> -->
            <!--begin::Col-->
            <div class="flex-lg-row-fluid me-lg-4 me-xl-2 mb-2">
                ...
                <div class="card card-flush h-xl-100 mt-2">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-gray-400 mt-1 fw-semibold fs-6">Total <span data-label="count-data">0</span> Customer</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Actions-->
                            ...
                            <table class="table align-middle  fs-6 gy-3 gs-3 table-hover table-sm table-row-bordered " id="main-table">
                                ...
                                <thead>
                                    ...
                                    <tr class="fw-bold text-muted bg-light">
                                        ...
                                        <th class="min-w-250px">Customer/Pelanggan</th>
            ...
            <!--end::Col-->
            <!--begin::Sidebar-->
            <div class="d-none d-lg-flex flex-column flex-lg-row-auto w-100 w-lg-350px pt-2" 
                data-kt-drawer="true" 
                ...
                <form action="{{$config['action']}}" method="post" enctype="multipart/form-data"id="kt_form_main" autocomplete="off">
                    ...
                    <div class="card card-flush mb-0" 
                        ...
                        <div class="card-header p-4">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark">{!!$config['title-icon']!!}Tambah Data Customer</span>
                            </h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Card header-->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-1 fv-row">
                                        <label for="name" class="required form-label">Nama Customer</label>
                                        <input type="text" name="name" class="form-control form-control-sm form-control-solid" maxlength="60" placeholder="Nama Customer">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-1 fv-row">
...
@endsection
@section('script')
@include('customers.index_script')
@endsection