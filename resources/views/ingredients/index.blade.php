                ...
                <div class="card card-flush h-xl-100 mt-7">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-gray-400 mt-1 fw-semibold fs-6">Total <span data-label="count-data">0</span> Barang/Bahan Baku</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Actions-->
                            ...
                            <table class="table align-middle  fs-6 gy-3 gs-3 table-hover table-sm table-row-bordered " id="main-table">
                                ...
                                <thead>
                                    ...
                                    <tr class="fw-bold text-muted bg-light">
                                        ...
                                        <th class="min-w-250px">Barang/Bahan</th>
                                        <th class="min-w-100px">Estimasi Harga/Unit</th>
                ...
                <form action="{{$config['action']}}" method="post" enctype="multipart/form-data"id="kt_form_main" autocomplete="off">
                    ...
                    <div class="card card-flush mb-0" 
                        ...
                        <div class="card-header pt-7">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark">{!!$config['title-icon']!!}Tambah Barang/Bahan Baku</span>
                            </h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Card header-->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-1 fv-row">
                                        <label for="name" class="required form-label">Nama Barang/Bahan Baku</label>
                                        <input type="text" name="name" class="form-control form-control-sm form-control-solid" maxlength="60" placeholder="Nama Barang/Bahan Baku">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-1 fv-row">
                                        <label for="unit" class="form-label required">Unit</label>
                                        <input type="text" name="unit" class="form-control form-control-sm form-control-solid" maxlength="36" placeholder="Unit: .....">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-1 fv-row">
                                ...
                                <div class="col-12">
                                    <div class="mb-1 fv-row">
                                        <label for="default_price" class="form-label required">Estimasi Harga/Unit</label>
...
@endsection
@section('script')
@include('ingredients.index_script')
@endsection