...
<div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div class="card card-flush h-xl-100 mt-7">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-gray-400 mt-1 fw-semibold fs-6">Total <span data-label="count-data">0</span> Kategori</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Actions-->
                ...
                <form action="{{$config['action']}}" method="post" enctype="multipart/form-data"id="kt_form_main" autocomplete="off">
                    ...
                    <div class="card card-flush mb-0" 
                        ...
                        <div class="card-header pt-7">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark">{!!$config['title-icon']!!}Tambah Katergori Menu</span>
                            </h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Card header-->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-1 fv-row">
                                        <label for="name" class="required form-label">Kategori Menu</label>
                                        <input type="text" name="name" class="form-control form-control-sm form-control-solid" maxlength="60" placeholder="Kategori Menu:...">
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="mb-1 fv-row">
                                ...
                                <div class="col-12"><span>*) Aktifkan jika Kategori bisa custom porsi (CS)</span></div>
                                <div class="col-12">
                                    <div class="mb-1 fv-row wrap-image">
    ...
    @include('category_menus.modal')
</div>
@endsection
@section('script')
@include('category_menus.index_script')
@endsection